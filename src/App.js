...
class App extends Component {
  constructor(){
    ...
    this.state={ 
        users:[
          {id:0,name:'Amir',color:'red',budget:20,rented:{}},
          {id:1,name:'Tomer',color:'green',budget:8,rented:{}},
          {id:2,name:'Gal',color:'magenta',budget:11,rented:{}},
          {id:3,name:'Ben',color:'maroon',budget:22,rented:{}}
      ],
      movies: [
  ...
  loadUsersFromStorage() {
    if(localStorage.users){
      this.state.users = JSON.parse(localStorage.users)
      console.log('updated users from localstorage');
    }
  }
